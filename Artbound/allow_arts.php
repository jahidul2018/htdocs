				...
				<?php
					...
					while($row=mysql_fetch_array($res))
					{
						...
						<div class="img_detail">
							...
							<div id="img_desc3">
								<p><a href="better_view.php?ArtID=<?php echo $row["ArtID"];?>"><?php echo $row["ArtName"];?></a> by <a href="art_owner.php?UserID=<?php echo $user_id;?>"><?php echo $first_name." ".$last_name;?></a></p><br/>
								...
								<form method="post" name="allow_arts">
									...
									<?php
										...
										if(isset($_POST["allow"])){
											...
											$query = "UPDATE Art SET AdminClearance='Allowed' WHERE ArtID='$art_id'";
											$res = mysql_query($query, $conn);
											 if(!$res){
												 ...
												 header('location: allow_arts.php');
											 }
										}
